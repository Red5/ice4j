...
public interface CandidateHarvester
{
     ...
     * CandidateHarvester supports. The gathered candidate addresses
     * are to be added by this CandidateHarvester to the specified
     * Component using
     ...
     * CandidateHarvester. Though they are to be added by this
     * CandidateHarvester to the specified component as soon
     ...
     *
     * @return true if this CandidateHarvester is a harvester
     * for host candidates.
     */
