...
public interface RequestListener
{
     ...
     * stack to reply with a 400 Bad Request {@link Response} using
     * the exception's message as a reason phrase for the error response. Any
     * other exception would result in a 500 Server Error {@link
     * Response}.
     *
     * @param evt the event containing the incoming STUN request.
     *
     * @throws IllegalArgumentException if evt contains a malformed
