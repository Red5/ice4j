...
public class SdpUtils {
     ...
     * agent using dummy codecs. This method is unlikely to be of use
     ...
     *
     * @return a {@link SessionDescription} representing agent's
     * streams.
     *
    ...
    /**
     * Configures localAgent the the remote peer streams, components,
     * and candidates specified in sdp
     *
     ...
     * content of the specified attribute or null if the
