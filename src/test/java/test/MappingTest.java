 ...
 * @author Emil Ivov
 */
public class MappingTest extends Ice {
    /**
    ...
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ...
            logger.info("Failed to create a NAT harvester for" + " local address=" + localAddressStr + " and public address=" + publicAddressStr);
            return;
        }
