...
public class MuxServerSocketChannelTest extends TestCase {
    ...
    public void testOpenAndBindReuseWhenBindingToAllInterfacesFirst() throws IOException {
        ...
        MuxServerSocketChannel channelForAllInterfaces = MuxServerSocketChannel.openAndBind(null, allInterfaces, 0, new DatagramPacketFilter() {
            @Override
        ...
        MuxServerSocketChannel channelForOneInterface = MuxServerSocketChannel.openAndBind(null, oneInterface, 0, new DatagramPacketFilter() {
            @Override
            public boolean accept(DatagramPacket p) {
                return false;
            }
